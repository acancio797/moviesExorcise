...
import com.exorcise.movie.api.responses.PopularMovie
...
class MoviesRepositoryImplTest {
    ...
    fun fetchPopularMovies() = runTest {
        ...
        val mockLocalDataRepository = mockk<MoviesLocalDataSource> {
            coEvery { incertMovies(any()) } returns Unit
        }

        val moviesRepository =
            MoviesRepositoryImpl(mockMoviesRemoteDataSource, mockConfigurationRepository,mockLocalDataRepository)
