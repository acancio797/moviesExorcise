...
class MoviesRemoteDataSourceTest {
    ...
    fun getPopularMovies() = runTest {
        ...
        val moviesRemoteDataSource =
            com.exorcise.data.api.data.movies.MoviesRemoteDataSource(
                mockMoviesApiClient,
                mockMoviesDao,
    ...
    fun getMovieDetails() = runTest {
        val movieDetailsResponse = com.exorcise.data.api.responses.MovieResponse(
            ...
            releaseDate = GregorianCalendar(2022, Calendar.MARCH, 1).time,
            genres = listOf(
                com.exorcise.data.api.responses.MovieResponse.Genre(id = 1, name = "Action"),
                com.exorcise.data.api.responses.MovieResponse.Genre(id = 2, name = "Crime")
            ),
            posterPath = "/batman-poster.jpg",
            backdropPath = "/batman-backdropPath.jpg",
            adult = false,
